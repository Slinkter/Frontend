apuntes
https://brazen-snapper-c98.notion.site/Curso-de-Consumo-de-API-REST-con-JavaScript-9e5200a0fe2e496a8f74228ef36721c3
...
```js
const querystring = ["?", "limit=3", "&order=Desc"].join("");
...
- **`503`** → *Service Unavailable*: indica que el servidor no está disponible temporalmente para procesar la solicitud.
...
```js
const query_string = ["?", "limit=2"].join("");
const API_KEY = ["&", "api_key=", "lover_W59yEyJV6jC9RT3YYGH80daxZBiTzY"].join(
  ""
);
