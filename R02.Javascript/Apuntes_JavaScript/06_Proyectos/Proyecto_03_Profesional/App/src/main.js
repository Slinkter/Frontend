...
/**
 * Fetches data from the API and renders the trending movies preview.
 * @async
...
// call -->  categorias
/**
 * Fetches data from the API and renders the categories preview.
 * @async
 * @returns {Promise<void>}
 */
...
// Utils 1
/**
 * Renders a list of movies into a DOM container.
 * Supports lazy loading and cleaning the container before rendering.
 *
 * @param {Array<Object>} movies - Array of movie objects from the API.
 * @param {HTMLElement} container - The DOM element where movies will be appended.
 * @param {Object} [options] - Options for rendering.
 * @param {boolean} [options.lazyLoad=false] - If true, uses IntersectionObserver for images.
 * @param {boolean} [options.clean=true] - If true, clears the container before adding elements.
 */
...
// Utils 2
/**
 * Renders a list of categories (genres) into a DOM container.
 *
 * @param {Array<Object>} categories - Array of category objects.
 * @param {HTMLElement} container - The DOM element destination.
 */
