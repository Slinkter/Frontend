 ...
 * It renders a `TodoIcon` with the 'check' type, dynamically changes its color based on `isCompleted` status,
 ...
 */
function CompleteIcon({ completed: isCompleted, onComplete }) {
    return (
        <TodoIcon
            type="check"
