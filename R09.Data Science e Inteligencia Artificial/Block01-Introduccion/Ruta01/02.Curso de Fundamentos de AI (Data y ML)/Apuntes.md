...
![Partimos del estado inicial, y realizando el diagrama de todas las posibles jugadas, Al tener Minie O (-1) información perfecta, va a ganarle a Max X (1) ](./imgs/decision-tree.png)
